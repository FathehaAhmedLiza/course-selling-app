      ...
      <div className="h-[1250px] md:h-[1050px] text-white container mx-auto">
        ...
        <section className="text-center py-20">
          ...
          <p className="text-gray-500">
           Learn smarter with content designed by the minds who know it best.
          </p>
          <div className="space-x-4 mt-8">
            ...
            <Link
              to={"https://www.youtube.com/@tat7057"}
                ...
                <div className="relative flex-shrink-0 w-92 transition-transform duration-300 transform hover:scale-105">
                  <div className="bg-gray-900 rounded-lg overflow-hidden">
                    ...
                    <div className="p-6 text-center">
                      ...
                      <Link to={`/buy/${course._id}`} className="mt-8 bg-orange-500 text-white py-0 px-4 rounded-full hover:bg-blue-500 duration-300">
                        Enroll Now
                      </Link>
                    </div>
                  </div>
