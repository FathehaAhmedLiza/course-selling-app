...
function Dashboard() {
  ...
  return (
    <div className="grid grid-cols-[256px_1fr] h-screen">
      {/* Sidebar */}
      <div className="bg-gradient-to-r from-black to-blue-950 p-5">
      ...
      {/* Main Content */}
      <div className="w-full min-h-screen bg-gradient-to-r from-black to-blue-950 text-white flex font-fredoka"></div>
        </div>
